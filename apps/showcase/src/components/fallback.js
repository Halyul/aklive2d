...
export default class Fallback {
  ...
  constructor(parentEl) {
    ...
    const fallback = () => {
      ...
      const scale = calculateScale(buildConfig.image_width, buildConfig.image_height);
      el.style.width = "100%";
      el.style.height = buildConfig.image_height * (scale.x > scale.y ? scale.y : scale.x) + "px";
    }
