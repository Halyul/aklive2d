...
window.operatorSettings = {
    ...
    fps: 60,
    animation: "Idle",
    // jsonUrl: "./operator/dyn_illust_char_472_pasngr_epoque#17.json",
    skelUrl: "./operator/dyn_illust_char_472_pasngr_epoque#17.skel",
    atlasUrl: "./operator/dyn_illust_char_472_pasngr_epoque#17.atlas",
    defaultMix: 0,
