...
window.operatorSettings = {
    ...
    fps: 60,
    animation: "Idle",
    // jsonUrl: "./operator/dyn_illust_char_113_cqbw_epoque#7_Start.json",
    skelUrl: "./operator/dyn_illust_char_113_cqbw_epoque#7_Start.skel",
    atlasUrl: "./operator/dyn_illust_char_113_cqbw_epoque#7_Start.atlas",
    defaultMix: 0,
