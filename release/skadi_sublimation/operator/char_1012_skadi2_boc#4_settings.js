...
window.operatorSettings = {
    ...
    fps: 60,
    animation: "Idle",
    // jsonUrl: "./operator/dyn_illust_char_1012_skadi2_boc#4.json",
    skelUrl: "./operator/dyn_illust_char_1012_skadi2_boc#4.skel",
    atlasUrl: "./operator/dyn_illust_char_1012_skadi2_boc#4.atlas",
    defaultMix: 0,
