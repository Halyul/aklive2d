...
window.operatorSettings = {
    ...
    fps: 60,
    animation: "Idle",
    // jsonUrl: "./operator/dyn_illust_char_350_surtr_summer#9.json",
    skelUrl: "./operator/dyn_illust_char_350_surtr_summer#9.skel",
    atlasUrl: "./operator/dyn_illust_char_350_surtr_summer#9.atlas",
    defaultMix: 0,
