...
(function (spine) {
	var SpineWidget = (function () {
		...
		SpineWidget.prototype.reRender = function (config) {
			var _this = this;
		...
		SpineWidget.prototype.load = function () {
			...
			if (assetManager.isLoadingComplete()) {
				...
				var atlasLoader = this.atlasLoader = new spine.AtlasAttachmentLoader(atlas);
		...
		SpineWidget.prototype.render = function () {
			...
			this.fpsDelta = now - this.lastFrameTime;
			// enough time passed, render next frame
		...
		SpineWidget.prototype.setFps = function (value) {
