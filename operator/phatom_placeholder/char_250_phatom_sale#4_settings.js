...
window.operatorSettings = {
    ...
    fps: 60,
    animation: "Idle",
    // jsonUrl: "./operator/dyn_illust_char_250_phatom_sale#4.json",
    skelUrl: "./operator/dyn_illust_char_250_phatom_sale#4.skel",
    atlasUrl: "./operator/dyn_illust_char_250_phatom_sale#4.atlas",
    defaultMix: 0,
