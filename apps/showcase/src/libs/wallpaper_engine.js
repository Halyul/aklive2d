...
window.wallpaperPropertyListener = {
    ...
    applyUserProperties: function (properties) {
        ...
        if (properties.logo) {
            document.dispatchEvent(
                Events.Logo.SetHidden.handler(!properties.logo.value)
            )
        }
        if (properties.logoratio) {
            if (properties.logoratio.value) {
                document.dispatchEvent(
                    Events.Logo.SetRatio.handler(properties.logoratio.value)
                )
            }
        }
        if (properties.logoopacity) {
            if (properties.logoopacity.value) {
                document.dispatchEvent(
                    Events.Logo.SetOpacity.handler(properties.logoopacity.value)
                )
            }
        }
        if (properties.logoimage) {
            if (properties.logoimage.value) {
                document.dispatchEvent(
                    Events.Logo.SetImage.handler(
                        'file:///' + properties.logoimage.value
                    )
                )
            } else {
        ...
        if (properties.logox) {
            document.dispatchEvent(
                Events.Logo.SetPosition.handler({
        ...
        if (properties.defaultbackground) {
            if (properties.defaultbackground.value) {
                document.dispatchEvent(
                    Events.Background.SetDefault.handler(
                        properties.defaultbackground.value
                    )
                )
            }
        }
        if (properties.background) {
            if (properties.background.value) {
                document.dispatchEvent(
                    Events.Background.SetCustom.handler(
                        `file:///${properties.background.value}`
                    )
                )
            } else {
        ...
        if (properties.voicetitle) {
            document.dispatchEvent(
                Events.Voice.SetUseVoice.handler(properties.voicetitle.value)
            )
        }
        if (properties.voicelanguage) {
            document.dispatchEvent(
                Events.Voice.SetLanguage.handler(properties.voicelanguage.value)
            )
        }
        if (properties.voiceidle) {
            document.dispatchEvent(
                Events.Voice.SetDuration.handler({
        ...
        if (properties.voicesubtitle) {
            document.dispatchEvent(
                Events.Voice.SetUseSubtitle.handler(
                    properties.voicesubtitle.value
                )
            )
        }
        if (properties.voicesubtitlelanguage) {
            document.dispatchEvent(
                Events.Voice.SetSubtitleLanguage.handler(
                    properties.voicesubtitlelanguage.value
                )
            )
        }
        if (properties.voicesubtitlex) {
            document.dispatchEvent(
                Events.Voice.SetSubtitlePosition.handler({
        ...
        if (properties.voiceactor) {
            document.dispatchEvent(
                Events.Voice.SetUseVoiceActor.handler(
                    properties.voiceactor.value
                )
            )
        }
        if (properties.music_selection) {
            document.dispatchEvent(
                Events.Music.SetMusic.handler(properties.music_selection.value)
            )
        }
        if (properties.music_title) {
            document.dispatchEvent(
                Events.Music.SetUseMusic.handler(properties.music_title.value)
            )
        }
        if (properties.music_volume) {
            document.dispatchEvent(
                Events.Music.SetVolume.handler(properties.music_volume.value)
            )
        }
        if (properties.custom_music) {
            if (properties.custom_music.value) {
                document.dispatchEvent(
                    Events.Music.SetCustom.handler(
                        `file:///${properties.custom_music.value}`
                    )
                )
            } else {
        ...
        if (properties.custom_video) {
            if (properties.custom_video.value) {
                document.dispatchEvent(
                    Events.Background.SetVideo.handler(
                        `file:///${properties.custom_video.value}`
                    )
                )
            } else {
        ...
        if (properties.video_volume) {
            document.dispatchEvent(
                Events.Background.SetVolume.handler(
                    properties.video_volume.value
                )
            )
        }
        if (properties.scale) {
            document.dispatchEvent(
                Events.Player.SetScale.handler(properties.scale.value)
            )
        }
        if (properties.position) {
            if (!properties.position.value) {
                ...
                document.dispatchEvent(
                    Events.Player.SetPadding.handler({
        ...
        if (properties.useStartAnimation) {
            document.dispatchEvent(
                Events.Player.SetUseStartAnimation.handler(
                    properties.useStartAnimation.value
                )
            )
        }
    },
