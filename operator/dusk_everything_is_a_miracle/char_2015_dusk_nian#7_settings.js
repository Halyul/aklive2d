...
window.operatorSettings = {
    ...
    fps: 60,
    animation: "Idle",
    // jsonUrl: "./operator/dyn_illust_char_2015_dusk_nian#7.json",
    skelUrl: "./operator/dyn_illust_char_2015_dusk_nian#7.skel",
    atlasUrl: "./operator/dyn_illust_char_2015_dusk_nian#7.atlas",
    defaultMix: 0,
